...
The first prompt that I provided the LLM was a monolithic prompts: "Target device: Lattice iCE40 UP5K FPGA with internal high-speed oscillator (~20 MHz).
...
In return, I recieved the following design linked [here](https://github.com/Isabella-Hottenrott/e155-lab3/blob/main/fpga/tb_scancounter.sv) that synthesized. 
...
In return, I recieved the following design linked [here](https://github.com/Isabella-Hottenrott/e155-lab3/blob/main/fpga/tb_scancounter.sv). This was the first of the designs returned by the LLM that did not synthesize. Claude attempted to import the wrong High Frequency Oscillator, as shown in the image below.

 ![Figure 8: AI Proto Biii Unsynthesizable Clock](images/aiBiii.png){fig-align="center"}