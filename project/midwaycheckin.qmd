...
The remaining work can be broken down into four categories. The most important aspect is driving the display, as that will ensure the entire game can function, and then additional verification is needed to meet all of our specifications. 
	...
	VL53L0X:
        Ensure measured distances are correct 
        Verify gesture recognition works with a variety of hands
    FPGA:
        Implement game logic 
        Drive display
        Integrate use of ROM
    Display: 
        Create all necessary display screens
	Physical Design:
        Prototype physical components 
        Integrate with ToF sensors 
